function [corr,err] = ...
                        getConfParamData(trackFile,startFrame,endFrame)
% GETCONFPARAMDATA Gets parameter vals used by algo. confidence classifer
%
...
corr = struct('delta_NCC_corr',delta_NCC_corr,...
                 ...
                 'delta_inliersL_corr',delta_inliersL_corr,...
                 'delta_inliersR_corr',delta_inliersR_corr,...
...
err = struct('delta_NCC_error',delta_NCC_error,...
                 ...
                 'delta_inliersL_error',delta_inliersL_error,...
                 'delta_inliersR_error',delta_inliersR_error,...
